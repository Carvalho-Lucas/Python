...
# Usando aspas simples (''), duplas (""), triplas (""" """) ou com \ pra quebrar linha.
...
print("Nome completo -> (2a Forma):" + nome_completo) #concatenação
...
print (f"Nome completo (9a Forma) com f: {nome} {sobrenome}")
print ("Nome completo (10a Forma) com format: {} {}".format(nome, sobrenome))
